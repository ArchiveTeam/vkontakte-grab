...
LUA_SHA1 = get_hash(os.path.join(CWD, 'vkontakte.lua'))
    ...
    def realize(self, item):
        ...
        for item_name in item['item_name'].split('\0'):
            ...
            if item_type == 'id' and not item_value.startswith('-'):
                ...
                item_user, item_post = item_value.split(':', 1)
                vkontakte_id = 'wall' + item_user + '_' + item_post
                wget_args.extend(['--warc-header', 'vkontakte-id: '+vkontakte_id])
                wget_args.append('https://vk.com/'+vkontakte_id)
            elif item_type == 'url':
...
project = Project(
    ...
    project_html='''
        ...
        <h2>vk.com <span class="links"><a href="https://vk.com/">Website</a> &middot; <a href="http://tracker.archiveteam.org/vkontakte/">Leaderboard</a></span></h2>
        <p>Archiving ВКонтакте (VKontakte).</p>
    '''
)
